...
const STATIC_TAXONOMY_OPTIONS = [
  ...
  { id: "57727a6e-9bd1-4e1a-9c08-5be7d9f22b55", name: "Clothing Pantry", parent_name: "Clothing", label: "Clothing / Clothing Pantry" },
  { id: "dc3e1a46-dcf0-4e76-9c27-780270893690", name: "Coat Drive", parent_name: "Clothing", label: "Clothing / Coat Drive" },
  { id: "a8b5f792-c995-4224-aced-fd8a3aaaf6d0", name: "Interview-Ready Clothing", parent_name: "Clothing", label: "Clothing / Interview-Ready Clothing" },
  { id: "61ab981d-6624-4afb-a664-b343daa2e58d", name: "Professional Clothing", parent_name: "Clothing", label: "Clothing / Professional Clothing" },
  { id: "89549deb-7654-4978-920e-cc7d6dd449f8", name: "Thrift Shop", parent_name: "Clothing", label: "Clothing / Thrift Shop" },

  { name: "Food", parent_name: null, label: "Food" },
  { id: "a2ccead8-2746-483e-99ee-acce661cebb0", name: "Brown Bag", parent_name: "Food", label: "Food / Brown Bag" },
  { id: "eb73f4e6-07b9-4377-a410-ff0bf3e70e4e", name: "Farmer's Markets", parent_name: "Food", label: "Food / Farmer's Markets" },
  { id: "d13c2a42-c7d6-47ef-b568-b50c40f7b191", name: "Food Pantry", parent_name: "Food", label: "Food / Food Pantry" },
  { id: "cf534c6e-e0c1-47b0-a318-f50a1312ab01", name: "Mobile Market", parent_name: "Food", label: "Food / Mobile Market" },
  { id: "0baa5976-f8b8-41bf-836d-b9e5e7716c92", name: "Mobile Pantry", parent_name: "Food", label: "Food / Mobile Pantry" },
  { id: "7c04ee94-5d9f-4222-839d-44c72b187ccc", name: "Mobile Soup Kitchen", parent_name: "Food", label: "Food / Mobile Soup Kitchen" },
  { id: "d14edeb8-e6c4-4afd-b09b-c2258f3abd87", name: "Soup Kitchen", parent_name: "Food", label: "Food / Soup Kitchen" },
  { id: "2305c645-f6ae-45d1-9435-abf460c35709", name: "Mobile Food Truck", parent_name: "Food", label: "Food / Mobile Food Truck" },
  { id: "25219279-8978-40ae-a499-7985cc424bfc", name: "Food Delivery / Meals on Wheels", parent_name: "Food", label: "Food / Food Delivery / Meals on Wheels" },
  { id: "dea3fd7b-a544-47ac-832a-80cdb6de51ac", name: "Food Benefits", parent_name: "Food", label: "Food / Food Benefits" },

  { name: "Health", parent_name: null, label: "Health" },
  { id: "f1b2ce87-5198-44a3-b177-48081faa2916", name: "General Health", parent_name: "Health", label: "Health / General Health" },
  { id: "197abf08-2386-4773-9ce4-c1bbdf1e857c", name: "Mental Health", parent_name: "Health", label: "Health / Mental Health" },
  { id: "10179fb2-1245-4e7c-9bf1-213da8fc269a", name: "Substance Use Treatment", parent_name: "Health", label: "Health / Substance Use Treatment" },
  { id: "e62816d3-587f-48d3-b080-ab56a9c63cc1", name: "Residential Recovery", parent_name: "Health", label: "Health / Residential Recovery" },

  { name: "Other service", parent_name: null, label: "Other service" },
  { id: "1571037b-9fa6-45e1-b137-1a8d376a2c35", name: "Benefits", parent_name: "Other service", label: "Other service / Benefits" },
  { id: "89a34ff3-d2c8-4a21-96c9-ea30918ea23e", name: "Case Workers", parent_name: "Other service", label: "Other service / Case Workers" },
  { id: "c1eb96d2-0acc-4e82-aced-a3ad65a776c0", name: "Education", parent_name: "Other service", label: "Other service / Education" },
  { id: "99040d88-e026-476d-b16a-0f54cef78289", name: "Employment", parent_name: "Other service", label: "Other service / Employment" },
  { id: "c6ed632a-b70f-44ad-98e8-0b159383ef8a", name: "Free Wifi", parent_name: "Other service", label: "Other service / Free Wifi" },
  { id: "d45ff9db-e25e-4eab-9526-cbd128e38bc6", name: "Legal Services", parent_name: "Other service", label: "Other service / Legal Services" },
  { id: "e19c3bfd-c312-42f3-b094-6e1ff12bd85a", name: "Mail", parent_name: "Other service", label: "Other service / Mail" },
  { id: "98a6f3e1-da8a-4cba-9f14-b04d347b5f2d", name: "Taxes", parent_name: "Other service", label: "Other service / Taxes" },
  { id: "4aeb0073-236a-4f42-9dae-f473ac13e005", name: "Community Services", parent_name: "Other service", label: "Other service / Community Services" },
  { id: "c980bff1-e071-44da-85cb-737383056ca1", name: "Advocates / Legal Aid", parent_name: "Other service", label: "Other service / Advocates / Legal Aid" },
  { id: "d5b6c888-6cb3-406b-ae3a-0a39acb83b3a", name: "Immigration Services", parent_name: "Other service", label: "Other service / Immigration Services" },
  { id: "58ffca15-8d3c-47f0-8a13-b415188c27c7", name: "Internship", parent_name: "Other service", label: "Other service / Internship" },
  { id: "d0fecba1-a474-41de-a0f5-86d6f3570127", name: "Appliances", parent_name: "Other service", label: "Other service / Appliances" },

  { name: "Personal Care", parent_name: null, label: "Personal Care" },
  { id: "221a7ab9-0e41-4863-98fb-be013dedb870", name: "Haircut", parent_name: "Personal Care", label: "Personal Care / Haircut" },
  { id: "3cb0e365-8867-4184-be14-fe50fd8d2cce", name: "Laundry", parent_name: "Personal Care", label: "Personal Care / Laundry" },
  { id: "71dd055d-631f-4039-8490-95710751862d", name: "Restrooms", parent_name: "Personal Care", label: "Personal Care / Restrooms" },
  { id: "238071c3-4dda-42d6-a534-551de95dd5f6", name: "Shower", parent_name: "Personal Care", label: "Personal Care / Shower" },
  { id: "e67dc5cf-e25d-496d-b3c3-d29018974c14", name: "Support Groups", parent_name: "Personal Care", label: "Personal Care / Support Groups" },
  { id: "7337607d-b5db-43c3-a38a-a20598117bf2", name: "Toiletries", parent_name: "Personal Care", label: "Personal Care / Toiletries" },
  { id: "7a8ac8f5-4ced-4ab8-882a-2f8f72d1738a", name: "Hygiene", parent_name: "Personal Care", label: "Personal Care / Hygiene" },
  { id: "a2b4d890-a7ac-4193-a6ce-bc51168cfa19", name: "Gym", parent_name: "Personal Care", label: "Personal Care / Gym" },
  { id: "0f46055a-8cbb-4ff9-885c-dca3fdb4af9c", name: "Activities", parent_name: "Personal Care", label: "Personal Care / Activities" },
  { id: "138f288d-bc5c-466d-b7e0-ef49f0b84d9f", name: "Baby Supplies", parent_name: "Personal Care", label: "Personal Care / Baby Supplies" },
  { id: "8c1253d3-bf15-4ffb-8997-8f8b6a84b7ab", name: "Baby", parent_name: "Personal Care", label: "Personal Care / Baby" },
  { id: "2b391d2b-c9a3-43dc-b811-20265cab0926", name: "Pets", parent_name: "Personal Care", label: "Personal Care / Pets" },

  { name: "Shelter", parent_name: null, label: "Shelter" },
  { id: "68f89dbb-fe15-4c20-82df-dc33f4ff765d", name: "Assessment", parent_name: "Shelter", label: "Shelter / Assessment" },
  { id: "d1cab9b9-3530-4fd9-9008-4e26328fac31", name: "Crisis", parent_name: "Shelter", label: "Shelter / Crisis" },
  { id: "67bde980-f426-4b5b-ae08-e82ff785fe75", name: "Families", parent_name: "Shelter", label: "Shelter / Families" },
  { id: "7401ee7a-d0a7-4c3a-b40f-933db160d52b", name: "LGBTQ Young Adult", parent_name: "Shelter", label: "Shelter / LGBTQ Young Adult" },
  { id: "9a9cd3d7-ea90-4903-9e62-b46217436853", name: "Single Adult", parent_name: "Shelter", label: "Shelter / Single Adult" },
  { id: "afec66ba-8f50-4938-aab2-3a16059b3fc8", name: "Veterans Short-Term Housing", parent_name: "Shelter", label: "Shelter / Veterans Short-Term Housing" },
  { id: "1b6de3a4-61d9-4d09-99a7-b988a82fa5dd", name: "Drop-in Center", parent_name: "Shelter", label: "Shelter / Drop-in Center" },
  { id: "c920be23-a658-469a-b84d-0e651e805afe", name: "Safe Haven", parent_name: "Shelter", label: "Shelter / Safe Haven" },
  { id: "f5a31255-ccde-4b7a-8f95-b99f130cdc0f", name: "Intake", parent_name: "Shelter", label: "Shelter / Intake" },
  { id: "2f30a82f-c6b3-42e8-88e5-37c01e2b7b08", name: "Supportive Housing", parent_name: "Shelter", label: "Shelter / Supportive Housing" },
  { id: "7f7fed92-4650-43e4-944b-b054a7ed9a1c", name: "Housing Lottery", parent_name: "Shelter", label: "Shelter / Housing Lottery" },
  { id: "e7846c93-b014-4400-a431-d626faa240c1", name: "Drop-in Center", parent_name: "Shelter", label: "Shelter / Drop-in Center (Alt)" },
  { id: "b1c631ba-b581-4609-b38d-7d9e74b954de", name: "Transitional Independent Living (TIL)", parent_name: "Shelter", label: "Shelter / Transitional Independent Living (TIL)" },
  { id: "6932e8da-1ac7-480e-98c8-3d21697f203b", name: "Warming Center", parent_name: "Shelter", label: "Shelter / Warming Center" },
  { id: "014ca48e-546b-4f72-84e5-c38156839813", name: "Referral", parent_name: "Shelter", label: "Shelter / Referral" },
  { id: "45d8145e-e159-402c-81d2-6c1460ca1c0b", name: "Veterans", parent_name: "Shelter", label: "Shelter / Veterans" },
  { id: "4a41fa33-64cb-4e14-ba87-99728cbbe9e9", name: "Senior", parent_name: "Shelter", label: "Shelter / Senior" },
  { id: "59a4ebe2-2aba-4aa0-9aa0-98260b76950f", name: "Youth", parent_name: "Shelter", label: "Shelter / Youth" }
];
