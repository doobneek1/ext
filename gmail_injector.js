  ...
  const broadSearch = [...document.querySelectorAll('div[contenteditable="true"]')]
    .find(el => el.offsetParent !== null && 
               (el.getAttribute('aria-label')?.includes('Message') || 
                el.id?.includes('editableContentHtml') ||
