...
(function injectDoobneekAttribution() {
  ...
  container.innerHTML = `Powered by <a href="http://localhost:8888" target="_blank" rel="noopener noreferrer" style="color: #0066cc; text-decoration: underline;">doobneek.org</a>`;
